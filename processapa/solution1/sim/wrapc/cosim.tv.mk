...
$(ObjDir)/processAPA.cxx_pre.cxx.tb.o : processAPA.cxx_pre.cxx.tb.cxx $(ObjDir)/.dir
	$(Echo) "   Compiling processAPA.cxx_pre.cxx.tb.cxx" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/FDHDChannelMapSP.cxx_pre.cxx.tb.o : FDHDChannelMapSP.cxx_pre.cxx.tb.cxx $(ObjDir)/.dir
	$(Echo) "   Compiling FDHDChannelMapSP.cxx_pre.cxx.tb.cxx" $(AVE_DIR_DLOG)
