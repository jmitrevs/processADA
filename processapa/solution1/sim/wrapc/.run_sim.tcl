...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2023.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "process_data.autotvin.dat"
	set constFileTvOut       "process_data.autotvout.dat"
	set constFileHdlTvIn     "process_data.autohdltvin.dat"
	set constFileHdlTvOut    "process_data.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
