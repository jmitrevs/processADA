...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.process_data.autotvin_gmem0.dat"
         "c.process_data.autotvin_gmem1.dat"
         "c.process_data.autotvin_gmem4.dat"
         "c.process_data.autotvin_infile_size.dat"
         "c.process_data.autotvin_infiledata.dat"
         "c.process_data.autotvin_chanmap_fUprightFromCrate.dat"
         "c.process_data.autotvin_chanmap_DetToChanInfo.dat"
         "c.process_data.autotvin_outdata.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.process_data.autotvout_gmem5.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
