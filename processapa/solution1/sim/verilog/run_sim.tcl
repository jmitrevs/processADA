...
if {[file isfile process_data.autotvin.dat]} {
	file delete -force process_data.autotvin.dat
}

if {[file isfile process_data.autotvout.dat]} {
	file delete -force process_data.autotvout.dat
}
