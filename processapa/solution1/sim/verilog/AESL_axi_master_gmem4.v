...
//------------------------Parameter----------------------
`define TV_IN_gmem4 "../tv/cdatafile/c.process_data.autotvin_gmem4.dat"
`define TV_OUT_gmem4 "../tv/rtldatafile/rtl.process_data.autotvout_gmem4.dat"
 parameter gmem4_ADDR_BITWIDTH = 32'd 64;
 parameter gmem4_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem4_DATA_BITWIDTH = 32'd 512;
...
parameter gmem4_C_DATA_BITWIDTH = 32'd 512;
parameter gmem4_mem_depth = 32'd 5760;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem4_mem_depth) begin
                $display ("/home/brenton/kernel/processAPA/processapa/solution1/sim/verilog/AESL_axi_master_gmem4.v: Write request address %d exceed AXI master gmem4 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem4_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem4_mem_depth) begin
                $display ("/home/brenton/kernel/processAPA/processapa/solution1/sim/verilog/AESL_axi_master_gmem4.v: Read request address %d exceed AXI master gmem4 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem4_mem_depth); 
                $finish;
            end
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer gmem4_bitwidth; 
  reg [512 - 1 : 0] token_tmp; 
  reg [gmem4_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  gmem4_bitwidth = gmem4_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (gmem4_bitwidth , factor);
      ...
      for(i = 0; i < gmem4_mem_depth; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : gmem4_mem_0[i/factor] = mem_tmp;
                      1 : gmem4_mem_1[i/factor] = mem_tmp;
                      2 : gmem4_mem_2[i/factor] = mem_tmp;
                      3 : gmem4_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : gmem4_mem_0[i] = mem_tmp;
                  1 : gmem4_mem_1[i] = mem_tmp;
                  2 : gmem4_mem_2[i] = mem_tmp;
                  3 : gmem4_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [gmem4_DATA_BITWIDTH - 1: 0] = 0;
          end
