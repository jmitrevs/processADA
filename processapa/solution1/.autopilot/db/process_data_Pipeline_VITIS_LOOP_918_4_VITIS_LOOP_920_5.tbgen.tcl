set moduleName process_data_Pipeline_VITIS_LOOP_918_4_VITIS_LOOP_920_5
set isTopModule 0
...
set C_modelName {process_data_Pipeline_VITIS_LOOP_918_4_VITIS_LOOP_920_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ zero_padding2d_input int 15 regular {fifo 1 volatile }  }
	{ planes int 15 regular {array 2880000 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "zero_padding2d_input", "interface" : "fifo", "bitwidth" : 15, "direction" : "WRITEONLY"} , 
 	{ "Name" : "planes", "interface" : "memory", "bitwidth" : 15, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ zero_padding2d_input_din sc_out sc_lv 15 signal 0 } 
	{ zero_padding2d_input_full_n sc_in sc_logic 1 signal 0 } 
	{ zero_padding2d_input_write sc_out sc_logic 1 signal 0 } 
	{ planes_address0 sc_out sc_lv 22 signal 1 } 
	{ planes_ce0 sc_out sc_logic 1 signal 1 } 
	{ planes_q0 sc_in sc_lv 15 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "planes_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "planes", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_918_4_VITIS_LOOP_920_5",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "planes", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_918_4_VITIS_LOOP_920_5", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter5", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter5", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_9ns_13ns_8ns_22_4_1_U472", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_VITIS_LOOP_918_4_VITIS_LOOP_920_5 {
		zero_padding2d_input {Type O LastRead -1 FirstWrite 5}
		planes {Type I LastRead 4 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	planes { ap_memory {  { planes_address0 mem_address 1 22 }  { planes_ce0 mem_ce 1 1 }  { planes_q0 in_data 0 15 } } }
}
