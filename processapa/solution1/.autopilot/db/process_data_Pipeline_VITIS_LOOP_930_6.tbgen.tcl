set moduleName process_data_Pipeline_VITIS_LOOP_930_6
set isTopModule 0
...
set C_modelName {process_data_Pipeline_VITIS_LOOP_930_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem5 int 32 regular {axi_master 1}  }
	{ sext_ln930 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem5", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "outdata","offset": { "type": "dynamic","port_name": "outdata","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln930", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln930 sc_in sc_lv 62 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln930", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln930", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_930_6",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	sext_ln930 { ap_none {  { sext_ln930 in_data 0 62 } } }
