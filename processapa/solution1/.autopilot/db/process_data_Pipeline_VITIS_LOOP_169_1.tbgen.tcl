set moduleName process_data_Pipeline_VITIS_LOOP_169_1
set isTopModule 0
...
set C_modelName {process_data_Pipeline_VITIS_LOOP_169_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 0}  }
	{ crate int 32 regular  }
	{ chanmap_fUprightFromCrate int 64 regular  }
	{ trunc_ln3 int 6 regular  }
	{ upri_out int 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "infiledata","offset": { "type": "dynamic","port_name": "infiledata","bundle": "control"},"direction": "READONLY"},{"cName": "chanmap_fAPANameFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fAPANameFromCrate","bundle": "control"},},{"cName": "chanmap_fUprightFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fUprightFromCrate","bundle": "control"},"direction": "READONLY"},{"cName": "chanmap_fCrateFromTPCSet","offset": { "type": "dynamic","port_name": "chanmap_fCrateFromTPCSet","bundle": "control"},},{"cName": "chanmap_fTPCSetFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fTPCSetFromCrate","bundle": "control"},},{"cName": "chanmap_DetToChanInfo","offset": { "type": "dynamic","port_name": "chanmap_DetToChanInfo","bundle": "control"},"direction": "READONLY"},{"cName": "outdata","offset": { "type": "dynamic","port_name": "outdata","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "crate", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "chanmap_fUprightFromCrate", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln3", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "upri_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ crate sc_in sc_lv 32 signal 1 } 
	{ chanmap_fUprightFromCrate sc_in sc_lv 64 signal 2 } 
	{ trunc_ln3 sc_in sc_lv 6 signal 3 } 
	{ upri_out sc_out sc_lv 32 signal 4 } 
	{ upri_out_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "crate", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "crate", "role": "default" }} , 
 	{ "name": "chanmap_fUprightFromCrate", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "chanmap_fUprightFromCrate", "role": "default" }} , 
 	{ "name": "trunc_ln3", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln3", "role": "default" }} , 
 	{ "name": "upri_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "upri_out", "role": "default" }} , 
 	{ "name": "upri_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "upri_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_169_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "crate", "Type" : "None", "Direction" : "I"},
			{"Name" : "chanmap_fUprightFromCrate", "Type" : "None", "Direction" : "I"},
			{"Name" : "trunc_ln3", "Type" : "None", "Direction" : "I"},
			{"Name" : "upri_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_VITIS_LOOP_169_1 {
		...
		crate {Type I LastRead 0 FirstWrite -1}
		chanmap_fUprightFromCrate {Type I LastRead 0 FirstWrite -1}
		trunc_ln3 {Type I LastRead 0 FirstWrite -1}
		upri_out {Type O LastRead -1 FirstWrite 72}}}
...
set Spec2ImplPortList { 
	...
	crate { ap_none {  { crate in_data 0 32 } } }
	chanmap_fUprightFromCrate { ap_none {  { chanmap_fUprightFromCrate in_data 0 64 } } }
	trunc_ln3 { ap_none {  { trunc_ln3 in_data 0 6 } } }
	upri_out { ap_vld {  { upri_out out_data 1 32 }  { upri_out_ap_vld out_vld 1 1 } } }
}
