set moduleName process_data_Pipeline_VITIS_LOOP_131_1
set isTopModule 0
...
set C_modelName {process_data_Pipeline_VITIS_LOOP_131_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ mul_ln134_1 int 22 regular  }
	{ phi_mul24 int 18 regular  }
	{ zext_ln131_1 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mul_ln134_1", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul24", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln131_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln134_1 sc_in sc_lv 22 signal 0 } 
	{ phi_mul24 sc_in sc_lv 18 signal 1 } 
	{ zext_ln131_1 sc_in sc_lv 14 signal 2 } 
	...
	{ planes_address0 sc_out sc_lv 22 signal 11 } 
	{ planes_ce0 sc_out sc_logic 1 signal 11 } 
	{ planes_we0 sc_out sc_logic 1 signal 11 } 
	{ planes_d0 sc_out sc_lv 15 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln134_1", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "mul_ln134_1", "role": "default" }} , 
 	{ "name": "phi_mul24", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "phi_mul24", "role": "default" }} , 
 	{ "name": "zext_ln131_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln131_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_131_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "mul_ln134_1", "Type" : "None", "Direction" : "I"},
			{"Name" : "phi_mul24", "Type" : "None", "Direction" : "I"},
			{"Name" : "zext_ln131_1", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_14_1_1_U52", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_VITIS_LOOP_131_1 {
		mul_ln134_1 {Type I LastRead 0 FirstWrite -1}
		phi_mul24 {Type I LastRead 0 FirstWrite -1}
		zext_ln131_1 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	mul_ln134_1 { ap_none {  { mul_ln134_1 in_data 0 22 } } }
	phi_mul24 { ap_none {  { phi_mul24 in_data 0 18 } } }
	zext_ln131_1 { ap_none {  { zext_ln131_1 in_data 0 14 } } }
