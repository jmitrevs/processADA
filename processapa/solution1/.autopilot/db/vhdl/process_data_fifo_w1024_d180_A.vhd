...
entity process_data_fifo_w1024_d180_A is
    generic (
...
architecture arch of process_data_fifo_w1024_d180_A is

    -- component
    component process_data_fifo_w1024_d180_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_process_data_fifo_w1024_d180_A_ram : process_data_fifo_w1024_d180_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity process_data_fifo_w1024_d180_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 1024;
        ADDR_WIDTH  : integer := 8;
...
architecture arch of process_data_fifo_w1024_d180_A_ram is
