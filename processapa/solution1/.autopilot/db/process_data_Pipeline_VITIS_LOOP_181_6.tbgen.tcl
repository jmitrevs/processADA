set moduleName process_data_Pipeline_VITIS_LOOP_181_6
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "infiledata","offset": { "type": "dynamic","port_name": "infiledata","bundle": "control"},"direction": "READONLY"},{"cName": "chanmap_fAPANameFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fAPANameFromCrate","bundle": "control"},},{"cName": "chanmap_fUprightFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fUprightFromCrate","bundle": "control"},"direction": "READONLY"},{"cName": "chanmap_fCrateFromTPCSet","offset": { "type": "dynamic","port_name": "chanmap_fCrateFromTPCSet","bundle": "control"},},{"cName": "chanmap_fTPCSetFromCrate","offset": { "type": "dynamic","port_name": "chanmap_fTPCSetFromCrate","bundle": "control"},},{"cName": "chanmap_DetToChanInfo","offset": { "type": "dynamic","port_name": "chanmap_DetToChanInfo","bundle": "control"},"direction": "READONLY"},{"cName": "outdata","offset": { "type": "dynamic","port_name": "outdata","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "trunc_ln183_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ trunc_ln183_1 sc_in sc_lv 6 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln183_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln183_1", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_181_6",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_VITIS_LOOP_181_6 {
...
set Spec2ImplPortList { 
	...
	trunc_ln183_1 { ap_none {  { trunc_ln183_1 in_data 0 6 } } }
}
