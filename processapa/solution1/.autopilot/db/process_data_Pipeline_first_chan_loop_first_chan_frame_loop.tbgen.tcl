...
set portList { 
	...
	{ adc_vectors_address0 sc_out sc_lv 21 signal 1 } 
	{ adc_vectors_ce0 sc_out sc_logic 1 signal 1 } 
	{ adc_vectors_q0 sc_in sc_lv 14 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "25605", "EstimateLatencyMax" : "25605",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_21ns_23ns_43_1_1_U7", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_9ns_13ns_7ns_21_4_1_U8", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_first_chan_loop_first_chan_frame_loop {
		ave {Type O LastRead -1 FirstWrite 4}
		adc_vectors {Type I LastRead 3 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25605", "Max" : "25605"}
	, {"Name" : "Interval", "Min" : "25605", "Max" : "25605"}
]}
