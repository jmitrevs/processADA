set moduleName process_data_Pipeline_VITIS_LOOP_215_6
set isTopModule 0
...
set C_modelName {process_data_Pipeline_VITIS_LOOP_215_6}
...
set portList { 
	...
	{ cc_prob_address0 sc_out sc_lv 2 signal 1 } 
	{ cc_prob_ce0 sc_out sc_logic 1 signal 1 } 
	{ cc_prob_q0 sc_in sc_lv 16 signal 1 } 
	{ outdata sc_in sc_lv 64 signal 2 } 
	{ trunc_ln217_1 sc_in sc_lv 5 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "process_data_Pipeline_VITIS_LOOP_215_6",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_215_6", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	process_data_Pipeline_VITIS_LOOP_215_6 {
