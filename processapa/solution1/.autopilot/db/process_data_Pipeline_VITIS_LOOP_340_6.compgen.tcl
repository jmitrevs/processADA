...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename cc_prob \
    op interface \
    ports { cc_prob_address0 { O 2 vector } cc_prob_ce0 { O 1 bit } cc_prob_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'cc_prob'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln342_1 \
    op interface \
    ports { trunc_ln342_1 { I 6 vector } } \
} "
}
