...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer16_out_din { O 128 vector } layer16_out_num_data_valid { I 2 vector } layer16_out_fifo_cap { I 2 vector } layer16_out_full_n { I 1 bit } layer16_out_write { O 1 bit } } \
} "
}
