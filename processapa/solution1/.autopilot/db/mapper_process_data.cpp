...
__xlx_chanmap_fUprightFromCrate__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_chanmap_fUprightFromCrate)[i]);
}
  int __xlx_size_param_chanmap_fUprightFromCrate = 75;
  int __xlx_offset_param_chanmap_fUprightFromCrate = 0;
  int __xlx_offset_byte_param_chanmap_fUprightFromCrate = 0*16;
  // Collect __xlx_chanmap_fCrateFromTPCSet__tmp_vec
std::vector<Byte<8>> __xlx_chanmap_fCrateFromTPCSet__tmp_vec;
for (size_t i = 0; i < 150; ++i){
__xlx_chanmap_fCrateFromTPCSet__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_chanmap_fCrateFromTPCSet)[i]);
}
  int __xlx_size_param_chanmap_fCrateFromTPCSet = 150;
  int __xlx_offset_param_chanmap_fCrateFromTPCSet = 0;
  int __xlx_offset_byte_param_chanmap_fCrateFromTPCSet = 0*8;
  // Collect __xlx_chanmap_fTPCSetFromCrate__tmp_vec
std::vector<Byte<8>> __xlx_chanmap_fTPCSetFromCrate__tmp_vec;
for (size_t i = 0; i < 150; ++i){
__xlx_chanmap_fTPCSetFromCrate__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_chanmap_fTPCSetFromCrate)[i]);
}
  int __xlx_size_param_chanmap_fTPCSetFromCrate = 150;
  int __xlx_offset_param_chanmap_fTPCSetFromCrate = 0;
  int __xlx_offset_byte_param_chanmap_fTPCSetFromCrate = 0*8;
  // Collect __xlx_chanmap_DetToChanInfo__tmp_vec
std::vector<Byte<64>> __xlx_chanmap_DetToChanInfo__tmp_vec;
for (size_t i = 0; i < 5760; ++i){
__xlx_chanmap_DetToChanInfo__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_chanmap_DetToChanInfo)[i]);
}
...
((Byte<16>*)__xlx_apatb_param_chanmap_fUprightFromCrate)[i] = __xlx_chanmap_fUprightFromCrate__tmp_vec[__xlx_offset_param_chanmap_fUprightFromCrate+i];
}
// print __xlx_apatb_param_chanmap_fCrateFromTPCSet
for (size_t i = 0; i < __xlx_size_param_chanmap_fCrateFromTPCSet; ++i) {
((Byte<8>*)__xlx_apatb_param_chanmap_fCrateFromTPCSet)[i] = __xlx_chanmap_fCrateFromTPCSet__tmp_vec[__xlx_offset_param_chanmap_fCrateFromTPCSet+i];
}
// print __xlx_apatb_param_chanmap_fTPCSetFromCrate
for (size_t i = 0; i < __xlx_size_param_chanmap_fTPCSetFromCrate; ++i) {
((Byte<8>*)__xlx_apatb_param_chanmap_fTPCSetFromCrate)[i] = __xlx_chanmap_fTPCSetFromCrate__tmp_vec[__xlx_offset_param_chanmap_fTPCSetFromCrate+i];
}
