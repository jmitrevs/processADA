...
namespace dune {
    ...
    public:
        ...
        unsigned int getNChans() const { return fNChans; }
    ...
    inline FDHDChannelMapSP::HDChanInfo_t FDHDChannelMapSP::GetChanInfoFromWIBElements (
        unsigned int crate,
        unsigned int slot,
        unsigned int link,
        unsigned int wibframechan ) const {
...
// ununderstood crates are mapped to the first crate in the APA name map
        ...
        const HDChanInfoStruct* fm4 = nullptr;
