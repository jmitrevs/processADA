...
#pragma HLS pipeline
               ...
               // a += adc; //throws violation
                	if(iFrame<100)
                	{
                		adc_vectors[iFrame][iChan] = adc; //fails cosim, problem with vector length for sure
                	}
                	...
                	else if(iFrame < 200)
			  {
				...
				{
				    adc_vectors7[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 800)
				{
				    adc_vectors8[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 900)
				{
				    adc_vectors9[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1000)
				{
				    adc_vectors10[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1100)
				{
				    adc_vectors11[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1200)
				{
				    adc_vectors12[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1300)
				{
				    adc_vectors13[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1400)
				{
				    adc_vectors14[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1500)
				{
				    adc_vectors15[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1600)
				{
				    adc_vectors16[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1700)
				{
				    adc_vectors17[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1800)
				{
				    adc_vectors18[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 1900)
				{
				    adc_vectors19[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2000)
				{
				    adc_vectors20[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2100)
				{
				    adc_vectors21[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2200)
				{
				    adc_vectors22[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2300)
				{
				    adc_vectors23[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2400)
				{
				    adc_vectors24[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2500)
				{
				    adc_vectors25[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2600)
				{
				    adc_vectors26[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2700)
				{
				    adc_vectors27[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2800)
				{
				    adc_vectors28[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 2900)
				{
				    adc_vectors29[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3000)
				{
				    adc_vectors30[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3100)
				{
				    adc_vectors31[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3200)
				{
				    adc_vectors32[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3300)
				{
				    adc_vectors33[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3400)
				{
				    adc_vectors34[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3500)
				{
				    adc_vectors35[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3600)
				{
				    adc_vectors36[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3700)
				{
				    adc_vectors37[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3800)
				{
				    adc_vectors38[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 3900)
				{
				    adc_vectors39[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4000)
				{
				    adc_vectors40[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4100)
				{
				    adc_vectors41[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4200)
				{
				    adc_vectors42[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4300)
				{
				    adc_vectors43[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4400)
				{
				    adc_vectors44[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4500)
				{
				    adc_vectors45[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4600)
				{
				    adc_vectors46[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4700)
				{
				    adc_vectors47[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4800)
				{
				    adc_vectors48[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 4900)
				{
				    adc_vectors49[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5000)
				{
				    adc_vectors50[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5100)
				{
				    adc_vectors51[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5200)
				{
				    adc_vectors52[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5300)
				{
				    adc_vectors53[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5400)
				{
				    adc_vectors54[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5500)
				{
				    adc_vectors55[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5600)
				{
				    adc_vectors56[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5700)
				{
				    adc_vectors57[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5800)
				{
				    adc_vectors58[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 5900)
				{
				    adc_vectors59[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
				else if(iFrame < 6000)
				{
				    adc_vectors60[iFrame][iChan] = adc; // throws violation AND fails cosim
				}
...
/*
            else if(offline_plane == 2 && offline_chan - CHAN_MIN >= z_channels)
            {
            	...
            	for (int i = 0; i < n_frames; i++)
            	{
            		...
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors7[iChan][i]-ave[iChan];
            		}
            		else if(i<800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors8[iChan][i]-ave[iChan];
            		}
            		else if(i<900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors9[iChan][i]-ave[iChan];
            		}
            		else if(i<1000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors10[iChan][i]-ave[iChan];
            		}
           		else if(i<1100)
            		{
             		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors11[iChan][i]-ave[iChan];
            		}
            		else if(i<1200)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors12[iChan][i]-ave[iChan];
            		}
            		else if(i<1300)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors13[iChan][i]-ave[iChan];
            		}
            		else if(i<1400)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors14[iChan][i]-ave[iChan];
            		}
            		else if(i<1500)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors15[iChan][i]-ave[iChan];
            		}
            		else if(i<1600)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors16[iChan][i]-ave[iChan];
            		}
            		else if(i<1700)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors17[iChan][i]-ave[iChan];
            		}
            		else if(i<1800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors18[iChan][i]-ave[iChan];
            		}
            		else if(i<1900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors19[iChan][i]-ave[iChan];
            		}
            		else if(i<2000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors20[iChan][i]-ave[iChan];
            		}
            		else if(i<2100)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors21[iChan][i]-ave[iChan];
            		}
            		else if(i<2200)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors22[iChan][i]-ave[iChan];
            		}
            		else if(i<2300)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors23[iChan][i]-ave[iChan];
            		}
            		else if(i<2400)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors24[iChan][i]-ave[iChan];
            		}
            		else if(i<2500)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors25[iChan][i]-ave[iChan];
            		}
            		else if(i<2600)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors26[iChan][i]-ave[iChan];
            		}
            		else if(i<2700)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors27[iChan][i]-ave[iChan];
            		}
            		else if(i<2800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors28[iChan][i]-ave[iChan];
            		}
            		else if(i<2900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors29[iChan][i]-ave[iChan];
            		}
            		else if(i<3000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors30[iChan][i]-ave[iChan];
            		}
            		else if(i<3100)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors31[iChan][i]-ave[iChan];
            		}
            		else if(i<3200)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors32[iChan][i]-ave[iChan];
            		}
            		else if(i<3300)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors33[iChan][i]-ave[iChan];
            		}
            		else if(i<3400)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors34[iChan][i]-ave[iChan];
            		}
            		else if(i<3500)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors35[iChan][i]-ave[iChan];
            		}
            		else if(i<3600)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors36[iChan][i]-ave[iChan];
            		}
            		else if(i<3700)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors37[iChan][i]-ave[iChan];
            		}
            		else if(i<3800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors38[iChan][i]-ave[iChan];
            		}
            		else if(i<3900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors39[iChan][i]-ave[iChan];
            		}
            		else if(i<4000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors40[iChan][i]-ave[iChan];
            		}
            		else if(i<4100)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors41[iChan][i]-ave[iChan];
            		}
            		else if(i<4200)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors42[iChan][i]-ave[iChan];
            		}
            		else if(i<4300)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors43[iChan][i]-ave[iChan];
            		}
            		else if(i<4400)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors44[iChan][i]-ave[iChan];
            		}
            		else if(i<4500)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors45[iChan][i]-ave[iChan];
            		}
            		else if(i<4600)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors46[iChan][i]-ave[iChan];
            		}
            		else if(i<4700)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors47[iChan][i]-ave[iChan];
            		}
            		else if(i<4800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors48[iChan][i]-ave[iChan];
            		}
            		else if(i<4900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors49[iChan][i]-ave[iChan];
            		}
            		else if(i<5000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors50[iChan][i]-ave[iChan];
            		}
            		else if(i<5100)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors51[iChan][i]-ave[iChan];
            		}
            		else if(i<5200)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors52[iChan][i]-ave[iChan];
            		}
            		else if(i<5300)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors53[iChan][i]-ave[iChan];
            		}
            		else if(i<5400)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors54[iChan][i]-ave[iChan];
            		}
            		else if(i<5500)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors55[iChan][i]-ave[iChan];
            		}
            		else if(i<5600)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors56[iChan][i]-ave[iChan];
            		}
            		else if(i<5700)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors57[iChan][i]-ave[iChan];
            		}
            		else if(i<5800)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors58[iChan][i]-ave[iChan];
            		}
            		else if(i<5900)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors59[iChan][i]-ave[iChan];
            		}
            		else if(i<6000)
            		{
            		    planes2[offline_chan - CHAN_MIN][i] = adc_vectors60[iChan][i]-ave[iChan];
            		}
