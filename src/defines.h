...
typedef ap_fixed<29,19> q_conv2d_3_accum_t;
typedef nnet::array<ap_fixed<29,19>, 8*1> q_conv2d_3_result_t;
...
typedef ap_fixed<18,8> q_conv2d_3_QActivation_table_t;
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0> max_pooling2d_2_accum_t;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 8*1> layer4_t;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 8*1> layer21_t;
typedef ap_fixed<24,16> q_conv2d_4_accum_t;
typedef nnet::array<ap_fixed<24,16>, 16*1> q_conv2d_4_result_t;
...
typedef ap_fixed<18,8> q_conv2d_4_QActivation_table_t;
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0> max_pooling2d_3_accum_t;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 16*1> layer7_t;
typedef ap_fixed<25,17> q_conv2d_5_accum_t;
typedef nnet::array<ap_fixed<25,17>, 32*1> q_conv2d_5_result_t;
...
typedef ap_fixed<18,8> q_conv2d_5_QActivation_table_t;
typedef ap_fixed<28,20> q_dense_2_accum_t;
typedef nnet::array<ap_fixed<28,20>, 12*1> q_dense_2_result_t;
...
typedef ap_fixed<18,8> q_dense_2_QActivation_table_t;
typedef ap_fixed<21,13> q_dense_3_accum_t;
typedef nnet::array<ap_fixed<21,13>, 2*1> q_dense_3_result_t;
